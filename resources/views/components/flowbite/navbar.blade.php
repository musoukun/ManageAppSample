    ...
    <div class="flex flex-wrap items-center justify-between">
        <div class="flex items-center justify-start">
            <button data-drawer-target="drawer-navigation" data-drawer-toggle="drawer-navigation"
                ...
                class="mr-2 mt-16 cursor-pointer rounded-lg p-2 text-gray-600 hover:bg-gray-100 hover:text-gray-900 focus:bg-gray-100 focus:ring-2 focus:ring-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:bg-gray-700 dark:focus:ring-gray-700 md:hidden">
            ...
            <a href="{{ route('manageapp.employee.search.get') }}" class="mr-4 flex items-center justify-between">
                <img src="{{ asset('images/ManageAppLogo.png') }}" class="mr-3 h-20 w-24 rounded-full"
                    alt="SampleApp Logo" />
                <span
                    class="self-center whitespace-nowrap text-3xl font-semibold text-orange-700 dark:text-white">ManageApp</span>
            </a>
        ...
        <div class="flex items-center lg:order-2">
            ...
            <div class="z-50 my-4 hidden max-w-sm list-none divide-y divide-gray-100 overflow-hidden rounded rounded-xl bg-white text-base shadow-lg dark:divide-gray-600 dark:bg-gray-700"
                ...
                <div
                    class="block bg-gray-50 py-2 px-4 text-center text-base font-medium text-gray-700 dark:bg-gray-600 dark:text-gray-300">
                    Notifications
                </div>
                <div>
                    <a href="#"
                        ...
                        <div class="flex-shrink-0">
                            <img class="h-14 w-18 rounded-full" src="{{ asset('images/ManageAppLogo.png') }}"
                                alt="tesque_ounce avatar" />
                            {{-- <div
                                ...
                                <svg aria-hidden="true" class="h-3 w-3 text-white" fill="currentColor"
                        ...
                        <div class="w-full pl-3">
                            <div class="mb-1.5 text-sm font-normal text-gray-500 dark:text-gray-400">
                                これは通知の
                                <span class="font-semibold text-gray-900 dark:text-white">サンプルです</span>:
                                "実際に通知機能は実装されていないですが、このように表現できるというサンプルです。"
                            </div>
                    ...
                    <a href="#"
                        ...
                        <div class="w-full pl-3">
                            <div class="mb-1.5 text-sm font-normal text-gray-500 dark:text-gray-400">
                                <span class="font-semibold text-gray-900 dark:text-white">SampleUser2</span>
                                が
                                <span class="font-medium text-gray-900 dark:text-white">5時間前に</span>
                                ～を承認しました。みたいなことが書けます。
                            </div>
                            <div class="text-xs font-medium text-primary-600 dark:text-primary-500">
                                10 minutes ago
                ...
                <a href="#"
                    ...
                    <div class="inline-flex items-center">
                        <svg aria-hidden="true" class="mr-2 h-4 w-4 text-gray-500 dark:text-gray-400"
            ...
            <button type="button"
                class="mx-3 flex h-12 w-12 rounded-full bg-white-800 text-sm focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600 md:mr-0"
                id="user-menu-button" aria-expanded="false" data-dropdown-toggle="dropdown">
                <span class="sr-only">Open user menu</span>
                <img class="h-15 w-20 rounded-full" src="{{ asset('images/user.png  ') }}" alt="user photo" />
            </button>
            <!-- Dropdown menu -->
            <div class="z-50 my-4 hidden w-56 list-none divide-y divide-gray-100 rounded rounded-xl bg-white text-base shadow dark:divide-gray-600 dark:bg-gray-700"
                id="dropdown">
                <div class="py-3 px-4">
                    <span class="block text-sm font-semibold text-gray-900 dark:text-white">サンプルユーザ</span>
                    <span class="block truncate text-sm text-gray-900 dark:text-white">sample@example.com</span>
                </div>
                <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                    <li>
                        <a href="#"
                            class="block py-2 px-4 text-sm hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">My
                            profile</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block py-2 px-4 text-sm hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">Account
                            settings</a>
                    </li>
                </ul>
                {{-- <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                    <li>
                        <a href="#"
                            class="flex items-center py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"><svg
                                class="mr-2 h-5 w-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                    ...
                    <li>
                        <a href="#"
                            ...
                            <span class="flex items-center">
                                <svg aria-hidden="true" class="text-primary-600 dark:text-primary-500 mr-2 h-5 w-5"
                                    fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                ...
                <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                    <li>
                        <form method="POST" action="{{ route('manageapp.logout') }}"
                            class="flex items-center py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            @csrf
                            <button
                                class="block py-2 text-sm hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white">Logout
                            </button>
                        </form>
                    </li>
                </ul>
